...
import com.example.ibtechbootcamphmfive.repo.MovieDetailRepo
import com.example.ibtechbootcamphmfive.room.RoomDB
import com.example.ibtechbootcamphmfive.ui.MovieDetailViewStateModel
...
class MovieDetailViewModel (private val context: Context, private val movieId: Int) : ViewModel() {
    ...
    private val apiRepository = MovieDetailRepo()
